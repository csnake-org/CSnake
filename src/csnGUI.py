...
class CSnakeGUIApp(wx.App):
    ...
    def InitFrame(self):
        ...
        self.binder.AddListBox("lbxRootFolders", buddyClass = "context", buddyField = "rootFolders", isFilename = True)
        self.binder.AddCheckBox("chkAskToLaunchVisualStudio", buddyClass = "options", buddyField = "_Options__askToLaunchIDE")
        
        self.binder.AddGrid("gridThirdPartySrcAndBuildFolders", buddyClass = "context", buddyField = "thirdPartySrcAndBuildFolders", isFilename = True)
    ...
    def SetContextModified(self, modified):
        ...
        if self.originalContextData != None:
            data = json.dumps(self.context.Dump(), sort_keys=True)
            equal = data == self.originalContextData
    ...
    def SaveContext(self, contextFilename):
        ...
        if saved:
            ...
            self.originalContextData = json.dumps(self.context.Dump(), sort_keys=True)
            # reset modified flag
