## @package csnVisualStudio2017
# Definition of the csnVisualStudio2017 compilers. 
# \ingroup compiler
import csnCompiler
import os

class Compiler(csnCompiler.Compiler):
    """ Abstract Visual Studio 2017 compiler. """
    def __init__(self):
...
class Compiler32(Compiler):
    """ Visual Studio 2017 32bits compiler. """
    def GetName(self):
...
class Compiler64(Compiler):
    """ Visual Studio 2017 64bits compiler. """
    def GetName(self):
