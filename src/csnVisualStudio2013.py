## @package csnVisualStudio2013
# Definition of the csnVisualStudio2013 compilers. 
# \ingroup compiler
import csnCompiler
import os

class Compiler(csnCompiler.Compiler):
    """ Abstract Visual Studio 2013 compiler. """
    def __init__(self):
...
class Compiler32(Compiler):
    """ Visual Studio 2013 32bits compiler. """
    def GetName(self):
...
class Compiler64(Compiler):
    """ Visual Studio 2013 64bits compiler. """
    def GetName(self):
