## @package csnVisualStudio2012
# Definition of the csnVisualStudio2012 compilers. 
# \ingroup compiler
import csnCompiler
import os

class Compiler(csnCompiler.Compiler):
    """ Abstract Visual Studio 2012 compiler. """
    def __init__(self):
...
class Compiler32(Compiler):
    """ Visual Studio 2012 32bits compiler. """
    def GetName(self):
...
class Compiler64(Compiler):
    """ Visual Studio 2012 64bits compiler. """
    def GetName(self):
